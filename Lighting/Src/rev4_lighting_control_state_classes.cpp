...
LC_State_STARTUP::LC_State_STARTUP() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_SE | 1 << LED_SIDE_NE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
...
LC_State_GROUND::LC_State_GROUND() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W | 1 << LED_SW | 1 << LED_SE;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_W
			| 1 << LED_E | 1 << LED_SW | 1 << LED_SIDE_NE
...
LC_State_TAXI::LC_State_TAXI() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_TAXI] = 1 << LED_SIDE_NE | 1 << LED_SIDE_NW | 1 << LED_SIDE_SE | 1 << LED_SIDE_SW;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_SE | 1 << LED_SW | 1 << LED_NE;
	domain_leds[CD_BRAKE] = 1 << LED_W | 1 << LED_E;
...
LC_State_TAKEOFF::LC_State_TAKEOFF() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	allowed_domains = 1 << CD_BEACON | 1 << CD_MAIN;
}
...
LC_State_FLIGHT::LC_State_FLIGHT() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_SW | 1 << LED_SE | 1 << LED_NE;
	domain_leds[CD_STROBE] = 1 << LED_E | 1 << LED_W;
...
LC_State_BRAKE::LC_State_BRAKE() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_BRAKE] = 1 << LED_NW | 1 << LED_SW | 1 << LED_SE | 1 << LED_NE;
...
LC_State_LANDING::LC_State_LANDING() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_SW;
	domain_leds[CD_BEACON] = 1 << LED_SE | 1 << LED_NE;
	domain_leds[CD_NAV] = 1 << LED_SIDE_NW | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE | 1 << LED_SIDE_SW;
	domain_leds[CD_LANDING] = 1 << LED_NW | 1 << LED_SW | 1 << LED_SE | 1 << LED_NE;
	allowed_domains = 1 << LED_E | 1 << LED_W;
}
...
LC_State_STANDBY::LC_State_STANDBY() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_STROBE] = 1 << LED_SIDE_NW | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE | 1 << LED_SIDE_SW;
	domain_leds[CD_BEACON] = 1 << LED_NW | 1 << LED_SW | 1 << LED_SE | 1 << LED_NE;
...
LC_State_SEARCH::LC_State_SEARCH() {
	...
	domain_leds[CD_MAIN] = 1 << LED_NW | 1 << LED_W |  1 << LED_SW  | 1 << LED_SE
			| 1 << LED_E | 1 << LED_NE | 1 << LED_SIDE_NE | 1 << LED_SIDE_SE
			| 1 << LED_SIDE_SW | 1 << LED_SIDE_NW;
	domain_leds[CD_SEARCH] = 1 << LED_NW | 1 << LED_SW | 1 << LED_SE | 1 << LED_NE
							| 1 << LED_E | 1 << LED_W;
